...
namespace SevenZipSharp
{
    ...
    public sealed class ProgressEventArgs : PercentDoneEventArgs
    {
        ...
        public ProgressEventArgs(byte percentDone, byte percentDelta) : base(percentDone)
        {
            _delta = percentDelta;
        }
    ...
    /// </summary>
    public sealed class CompressionErrorEventArgs : EventArgs
    {
        ...
        public CompressionErrorEventArgs(CompressionErrorBehavior defaultAction, CompressionErrorType errorType,
            string sourceFile, string archiveFile, Exception ex)
        {
            ActionToTake = defaultAction;
            ErrorType = errorType;
        ...
        /// </summary>
        public CompressionErrorBehavior ActionToTake { get; set; }

        /// <summary>   The type of error that occurred.</summary>
        public CompressionErrorType ErrorType { get; private set; }
    ...
    public sealed class FileInfoEventArgs : PercentDoneEventArgs, ICancellable
    {
        ...
        /// <param name="percentDone">The percent of finished work.</param>
        public FileInfoEventArgs(ArchiveFileInfo fileInfo, byte percentDone) : base(percentDone)
        {
            _fileInfo = fileInfo;
        }
    ...
    public sealed class FileNameEventArgs : PercentDoneEventArgs, ICancellable
    {
        ...
        /// <param name="percentDone">The percent of finished work</param>
        public FileNameEventArgs(string fileName, byte percentDone) : base(percentDone)
        {
            _fileName = fileName;
        }
    ...
    /// <summary>
    /// Callback delegate for <see cref="SevenZipExtractor.ExtractFiles(SevenZipSharp.ExtractFileCallback)"/>.
    /// </summary>
