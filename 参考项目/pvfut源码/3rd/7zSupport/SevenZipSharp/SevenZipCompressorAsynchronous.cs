...
namespace SevenZipSharp
{
    partial class SevenZipCompressor
    {
        ...
        private delegate void CompressFiles4Delegate(Stream archiveStream, int commonRootLength,
            string[] fileFullNames);

        private delegate void CompressFilesEncrypted1Delegate(string archiveName, string password,
            string[] fileFullNames);

        private delegate void CompressFilesEncrypted2Delegate(Stream archiveStream, string password,
            string[] fileFullNames);

        private delegate void CompressFilesEncrypted3Delegate(string archiveName, int commonRootLength, string password,
            string[] fileFullNames);

        private delegate void CompressFilesEncrypted4Delegate(Stream archiveStream, int commonRootLength,
            string password, string[] fileFullNames);
        ...
        private delegate void CompressDirectory5Delegate(string directory, string archiveName, string password,
            string searchPattern, bool recursion);

        private delegate void CompressDirectory6Delegate(string directory, Stream archiveStream, string password,
            string searchPattern, bool recursion);
        ...
        public void BeginCompressFiles(string archiveName, DispatcherPriority eventPriority,
        ...
        /// <param name="eventPriority">The priority of events, relative to the other pending operations in the System.Windows.Threading.Dispatcher event queue, the specified method is invoked.</param>
        public void BeginCompressFiles(Stream archiveStream, DispatcherPriority eventPriority,
            params string[] fileFullNames)
        {
            SaveContext(eventPriority);
        ...
        /// <param name="archiveName">The archive file name.</param>
        /// <param name="eventPriority">The priority of events, relative to the other pending operations in the System.Windows.Threading.Dispatcher event queue, the specified method is invoked.</param>
        public void BeginCompressFiles(string archiveName, int commonRootLength, DispatcherPriority eventPriority,
            params string[] fileFullNames)
        {
            SaveContext(eventPriority);
        ...
        /// Use CompressFiles(string archiveName, ... ) overloads for archiving to disk.</param>
        /// <param name="eventPriority">The priority of events, relative to the other pending operations in the System.Windows.Threading.Dispatcher event queue, the specified method is invoked.</param>
        public void BeginCompressFiles(Stream archiveStream, int commonRootLength, DispatcherPriority eventPriority,
            params string[] fileFullNames)
        {
            SaveContext(eventPriority);
        ...
        /// <param name="eventPriority">The priority of events, relative to the other pending operations in the System.Windows.Threading.Dispatcher event queue, the specified method is invoked.</param>
        public void BeginCompressFilesEncrypted(string archiveName, string password, DispatcherPriority eventPriority,
            params string[] fileFullNames)
        {
            SaveContext(eventPriority);
        ...
        /// <param name="password">The archive password.</param>
        /// <param name="eventPriority">The priority of events, relative to the other pending operations in the System.Windows.Threading.Dispatcher event queue, the specified method is invoked.</param>
        public void BeginCompressFilesEncrypted(Stream archiveStream, string password, DispatcherPriority eventPriority,
            params string[] fileFullNames)
        {
            SaveContext(eventPriority);
        ...
        /// <param name="commonRootLength">The length of the common root of the file names.</param>
        /// <param name="eventPriority">The priority of events, relative to the other pending operations in the System.Windows.Threading.Dispatcher event queue, the specified method is invoked.</param>
        public void BeginCompressFilesEncrypted(string archiveName, int commonRootLength, string password,
            DispatcherPriority eventPriority, params string[] fileFullNames)
        {
            SaveContext(eventPriority);
            (new CompressFilesEncrypted3Delegate(CompressFilesEncrypted)).BeginInvoke(archiveName, commonRootLength,
                password, fileFullNames, AsyncCallbackImplementation, this);
        }
        ...
        /// <param name="commonRootLength">The length of the common root of the file names.</param>
        /// <param name="eventPriority">The priority of events, relative to the other pending operations in the System.Windows.Threading.Dispatcher event queue, the specified method is invoked.</param>
        public void BeginCompressFilesEncrypted(Stream archiveStream, int commonRootLength, string password,
            DispatcherPriority eventPriority, params string[] fileFullNames)
        {
            SaveContext(eventPriority);
        ...
        /// <param name="eventPriority">The priority of events, relative to the other pending operations in the System.Windows.Threading.Dispatcher event queue, the specified method is invoked.</param>
        public void BeginCompressDirectory(string directory, string archiveName, string password = "",
            string searchPattern = "*", bool recursion = true,
            DispatcherPriority eventPriority = DispatcherPriority.Normal)
        {
            SaveContext(eventPriority);
            (new CompressDirectory5Delegate(CompressDirectory)).BeginInvoke(directory, archiveName, password,
                searchPattern, recursion, AsyncCallbackImplementation, this);
        }
        ...
        /// <param name="recursion">If true, files will be searched for recursively; otherwise, not.</param>
        /// <param name="eventPriority">The priority of events, relative to the other pending operations in the System.Windows.Threading.Dispatcher event queue, the specified method is invoked.</param>
        public void BeginCompressDirectory(string directory, Stream archiveStream, string password = "",
            string searchPattern = "*", bool recursion = true,
            DispatcherPriority eventPriority = DispatcherPriority.Normal)
        {
            SaveContext(eventPriority);
            (new CompressDirectory6Delegate(CompressDirectory)).BeginInvoke(directory, archiveStream, password,
                searchPattern, recursion, AsyncCallbackImplementation, this);
        }
        ...
        /// <param name="password">The archive password.</param>
        /// <param name="eventPriority">The priority of events, relative to the other pending operations in the System.Windows.Threading.Dispatcher event queue, the specified method is invoked.</param>
        public void BeginModifyArchive(string archiveName, Dictionary<int, string> newFileNames, string password = "",
            DispatcherPriority eventPriority = DispatcherPriority.Normal)
        {
            SaveContext(eventPriority);
