...
*/
    ...
    internal interface IArchiveExtractCallback
    {
        ...
        [PreserveSig]
        int GetStream(uint index, [Out, MarshalAs(UnmanagedType.Interface)]
            out ISequentialOutStream outStream, AskMode askExtractMode);
    ...
    internal interface IArchiveOpenVolumeCallback
    {
        ...
        /// <returns>Zero if Ok</returns>
        [PreserveSig]
        int GetStream([MarshalAs(UnmanagedType.LPWStr)] string name, [Out, MarshalAs(UnmanagedType.Interface)]
    ...
    internal interface ISequentialInStream
    {
        ...
        /// </remarks>
        int Read([Out, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1)]
            byte[] data, uint size);
    }
    ...
    internal interface ISequentialOutStream
    {
        ...
        /// </remarks>
        [PreserveSig]
        int Write([In, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1)]
            byte[] data, uint size, IntPtr processedSize);
    }
    ...
    internal interface IInArchive
    {
        ...
        /// <returns></returns>
        [PreserveSig]
        int Open(IInStream stream, [In] ref ulong maxCheckStartPosition,
        ...
        void GetProperty(uint index, ItemPropId propId, ref PropVariant value); // PropVariant
        ...
        [PreserveSig]
        int Extract([MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1)]
            uint[] indexes, uint numItems, int testMode,
        ...
        void GetArchiveProperty(ItemPropId propId, // PROPID
        ...
        void GetPropertyInfo(uint index, [MarshalAs(UnmanagedType.BStr)] out string name,
        ...
        /// <param name="propId">Property identificator</param>
        /// <param name="varType">Variant type</param>
        void GetArchivePropertyInfo(uint index, [MarshalAs(UnmanagedType.BStr)] out string name,
            out ItemPropId propId, // PROPID
            out ushort varType); //VARTYPE
    }
    ...
    internal interface IOutArchive
    {
        ...
        /// <returns>Zero if Ok</returns>
        [PreserveSig]
        int UpdateItems([MarshalAs(UnmanagedType.Interface)] ISequentialOutStream outStream, uint numItems,
