...
namespace Aga.Controls.Tree
{
	...
	public sealed class TreeNodeAdv : ISerializable
	{
		...
		public async Task Collapse(bool ignoreChildren)
		{
		    await SetIsExpanded(false, ignoreChildren);
		}
		...
		public async Task Expand(bool ignoreChildren)
		{
		    await SetIsExpanded(true, ignoreChildren);
		}

		private async Task SetIsExpanded(bool value, bool ignoreChildren)
		{
			if (Tree == null)
				_isExpanded = value;
			else
			    await Tree.SetIsExpanded(this, value, ignoreChildren);
		}
